...
/**
Driver for the Bosch BMP280 Pressure and Temperature sensor, using either I2C or SPI.
*/
class Bmp280:
  ...
  on:
    ...
    tries := 5
    while (reg_.read-u8 REGISTER-CHIPID_) != 0x58:
      tries--
  ...
  read-pressure -> float:
    ...
    if adc-P == 0x800000: throw "BMP280: sensor is busy"
